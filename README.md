...
**My Events Dashboard**: Manage your schedule with tabs for interested, going, created, and history.

**Haptic Feedback**: Subtle vibrations when interacting with participation buttons(interested/going).

**Role-Based Access**: Event creators have exclusive Admin controls (Edit/Delete), while participants see joining options.
